...
namespace mex_hal
{
    ...
    private:
        ...
        /**
         * @brief Scan for PWM devices and populate pwmDevices_ vector
         */
        void scanPWM();

        /**
         * @brief Scan for ADC devices and populate adcDevices_ vector
         */
        void scanADC();
        ...
        std::vector<PWMInfo> pwmDevices_;
        std::vector<ADCInfo> adcDevices_;
    ...
    public:
        ...
        /**
         * @brief Get the list of detected PWM devices
         * @return Vector of PWMInfo structures
         */
        [[nodiscard]] const std::vector<PWMInfo>& getPwmInfos() const { return pwmDevices_; }

        /**
         * @brief Get the list of detected ADC devices
         * @return Vector of ADCInfo structures
         */
        [[nodiscard]] const std::vector<ADCInfo>& getAdcInfos() const { return adcDevices_; }
